...
class TestMatchQualityColumnFactory:
    ...
    def test_factory_uses_numeric_sorting(self) -> None:
        ...
        # The provider should be wrapped with NumericSortAdapter
        assert hasattr(column.delegate_provider, '_base')
        assert hasattr(column.delegate_provider, '_parser')
        ...
        # The adapter should return a tuple for sorting
        sort_key = column.delegate_provider.sort_key(mock_album)
